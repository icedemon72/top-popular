                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                @elseif (($page === $paginator->currentPage() + 1 || $page === $paginator->currentPage() + 2) || $page === $paginator->lastPage() || $page === 1 || $page === $paginator->currentPage() - 1 || $page === $paginator->currentPage() - 2)
